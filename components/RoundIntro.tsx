    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-10 left-10 opacity-10">
          <Compass
            className="w-32 h-32 text-[#4BA3FF] animate-spin-slow"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        ...
        <div className="mb-8 animate-fade-in">
          <Badge
            variant="secondary"
            className="text-lg px-6 py-2 bg-[#FFC832] text-[#111318] border-2 border-[#E6B42E]"
          >
        ...
        >
          ...
          <p className="text-2xl text-[#FFC832] drop-shadow-lg">
            Your head hurts... figure out where you are before the fare
            skyrockets!
          </p>
        </div>
        ...
        {/* Difficulty Card */}
        <Card
          className="max-w-md w-full mb-8 animate-scale-in"
          ...
          <CardContent className="p-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-amber-900 italic text-center">
                💫 Your head is pounding and you can't remember how you got
                here... but your wallet might hurt more if you guess late!
              </p>
            </div>
            ...
            <div className="bg-[#FFC832]/10 border border-[#FFC832]/30 rounded-lg p-4">
              ...
              <ul className="text-sm text-[#E6B42E] space-y-1.5">
                <li>
                  • Chat freely with your taxi driver (conversations are free!)
                </li>
